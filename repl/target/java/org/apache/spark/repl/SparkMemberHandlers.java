...
public abstract interface SparkMemberHandlers {
  public abstract  org.apache.spark.repl.SparkIMain intp () ;
  private  java.lang.String codegenln (boolean leadingPlus, scala.collection.Seq<java.lang.String> xs) ;
  private  java.lang.String codegenln (scala.collection.Seq<java.lang.String> xs) ;
  private  java.lang.String codegen (scala.collection.Seq<java.lang.String> xs) ;
  private  java.lang.String codegen (boolean leadingPlus, scala.collection.Seq<java.lang.String> xs) ;
  private  java.lang.String name2string (scala.reflect.internal.Names.Name name) ;
  ...
  // not preceding
  private  org.apache.spark.repl.SparkMemberHandlers.ImportVarsTraverser$ ImportVarsTraverser () ;

...
public abstract interface SparkImports {
  public  boolean isNoImports () ;
  public  boolean isNoPredef () ;
  /** Synthetic import handlers for the language defined imports. */
  private  org.apache.spark.repl.SparkMemberHandlers.ImportHandler makeWildcardImportHandler (scala.reflect.internal.Symbols.Symbol sym) ;
  ...
  protected  org.apache.spark.repl.SparkImports.SparkComputedImports importsCode (scala.collection.immutable.Set<scala.reflect.internal.Names.Name> wanted, boolean definedClass) ;
  private  scala.collection.immutable.List<scala.Tuple2<org.apache.spark.repl.SparkIMain.Request, org.apache.spark.repl.SparkMemberHandlers.MemberHandler>> allReqAndHandlers () ;
  private  scala.collection.immutable.List<scala.reflect.internal.Symbols.Symbol> membersAtPickler (scala.reflect.internal.Symbols.Symbol sym) ;
  private  int curValId () ;
  private  int newValId () ;
}

...
public  class SparkIMain implements org.apache.spark.repl.SparkImports, org.apache.spark.Logging {
  ...
  public  class ReadEvalPrint {
    ...
    private  scala.Nothing evalError (java.lang.String path, java.lang.Throwable ex) { throw new RuntimeException(); }
  ...
  static public abstract interface CodeAssembler<T extends java.lang.Object> {
    public abstract  java.lang.String preamble () ;
    public abstract  scala.Function1<T, java.lang.String> generate () ;
    public abstract  java.lang.String postamble () ;
    public  java.lang.String apply (scala.collection.immutable.List<T> contributors) ;
  }
  static public abstract interface StrippingWriter {
    public abstract  boolean isStripping () ;
    public abstract  java.lang.String stripImpl (java.lang.String str) ;
    public  java.lang.String strip (java.lang.String str) ;
  }
  static public abstract interface TruncatingWriter {
    public abstract  int maxStringLength () ;
    public abstract  boolean isTruncating () ;
  ...
  // not preceding
  public   SparkIMain (scala.tools.nsc.Settings initialSettings, java.io.PrintWriter out) { throw new RuntimeException(); }

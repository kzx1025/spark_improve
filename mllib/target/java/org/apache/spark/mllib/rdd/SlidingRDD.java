 ...
 */
private  class SlidingRDD<T extends java.lang.Object> extends org.apache.spark.rdd.RDD<scala.collection.Seq<T>> {
  ...
  public  scala.collection.Iterator<scala.collection.Seq<T>> compute (org.apache.spark.Partition split, org.apache.spark.TaskContext context, org.apache.spark.scheduler.ShuffleMemorySignal shuffleMemorySignal) { throw new RuntimeException(); }

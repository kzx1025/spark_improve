 ...
 */
private  class RDDFunctions<T extends java.lang.Object> {
   ...
   * greater than 1.
   */
  public  org.apache.spark.rdd.RDD<scala.collection.Seq<T>> sliding (int windowSize) { throw new RuntimeException(); }
  /**

...
public  class KMeans implements scala.Serializable, org.apache.spark.Logging {
   ...
   */
  static private  scala.Tuple2<java.lang.Object, java.lang.Object> findClosest (scala.collection.TraversableOnce<org.apache.spark.mllib.clustering.BreezeVectorWithNorm> centers, org.apache.spark.mllib.clustering.BreezeVectorWithNorm point) { throw new RuntimeException(); }
  /**
   * Returns the K-means cost of a given point against the given cluster centers.
   */
  static private  double pointCost (scala.collection.TraversableOnce<org.apache.spark.mllib.clustering.BreezeVectorWithNorm> centers, org.apache.spark.mllib.clustering.BreezeVectorWithNorm point) { throw new RuntimeException(); }
  /**
   * Returns the squared Euclidean distance between two vectors computed by
   * {@link org.apache.spark.mllib.util.MLUtils#fastSquaredDistance}.
   */
  static private  double fastSquaredDistance (org.apache.spark.mllib.clustering.BreezeVectorWithNorm v1, org.apache.spark.mllib.clustering.BreezeVectorWithNorm v2) { throw new RuntimeException(); }
   ...
   */
  private  org.apache.spark.mllib.clustering.KMeansModel runBreeze (org.apache.spark.rdd.RDD<org.apache.spark.mllib.clustering.BreezeVectorWithNorm> data) { throw new RuntimeException(); }
  /**
   * Initialize <code>runs</code> sets of cluster centers at random.
   */
  private  org.apache.spark.mllib.clustering.BreezeVectorWithNorm[][] initRandom (org.apache.spark.rdd.RDD<org.apache.spark.mllib.clustering.BreezeVectorWithNorm> data) { throw new RuntimeException(); }
  /**
   ...
   */
  private  org.apache.spark.mllib.clustering.BreezeVectorWithNorm[][] initKMeansParallel (org.apache.spark.rdd.RDD<org.apache.spark.mllib.clustering.BreezeVectorWithNorm> data) { throw new RuntimeException(); }
}

...
private  class LocalKMeans implements org.apache.spark.Logging {
   ...
   */
  static public  org.apache.spark.mllib.clustering.BreezeVectorWithNorm[] kMeansPlusPlus (int seed, org.apache.spark.mllib.clustering.BreezeVectorWithNorm[] points, double[] weights, int k, int maxIterations) { throw new RuntimeException(); }

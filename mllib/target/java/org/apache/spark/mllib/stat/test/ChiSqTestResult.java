...
public  class ChiSqTestResult implements org.apache.spark.mllib.stat.test.TestResult<java.lang.Object> {
  ...
  // not preceding
  private   ChiSqTestResult (double pValue, int degreesOfFreedom, double statistic, java.lang.String method, java.lang.String nullHypothesis) { throw new RuntimeException(); }

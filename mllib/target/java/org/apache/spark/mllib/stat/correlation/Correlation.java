 ...
 */
private abstract interface Correlation {
  /**
   * Compute correlation for two datasets.
   */
  public abstract  double computeCorrelation (org.apache.spark.rdd.RDD<java.lang.Object> x, org.apache.spark.rdd.RDD<java.lang.Object> y) ;
  /**
   ...
   */
  public abstract  org.apache.spark.mllib.linalg.Matrix computeCorrelationMatrix (org.apache.spark.rdd.RDD<org.apache.spark.mllib.linalg.Vector> X) ;
  /**

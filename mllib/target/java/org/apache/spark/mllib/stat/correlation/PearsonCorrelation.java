 ...
 */
private  class PearsonCorrelation implements org.apache.spark.mllib.stat.correlation.Correlation, org.apache.spark.Logging {
  /**
  ...
  static private  boolean closeToZero (double value, double threshhold) { throw new RuntimeException(); }
}

...
private  class TreePoint implements scala.Serializable {
   ...
   * @param bins      Bins for features, of size (numFeatures, numBins).
   */
  static private  org.apache.spark.mllib.tree.impl.TreePoint labeledPointToTreePoint (org.apache.spark.mllib.regression.LabeledPoint labeledPoint, org.apache.spark.mllib.tree.model.Bin[][] bins, org.apache.spark.mllib.tree.impl.DecisionTreeMetadata metadata) { throw new RuntimeException(); }
  /**
   ...
   */
  static private  int findBin (int featureIndex, org.apache.spark.mllib.regression.LabeledPoint labeledPoint, boolean isFeatureContinuous, boolean isUnorderedFeature, org.apache.spark.mllib.tree.model.Bin[][] bins, scala.collection.immutable.Map<java.lang.Object, java.lang.Object> categoricalFeaturesInfo) { throw new RuntimeException(); }

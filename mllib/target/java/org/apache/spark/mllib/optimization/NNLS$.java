...
private  class NNLS$ {
   ...
   */
  public  double[] solve (org.jblas.DoubleMatrix ata, org.jblas.DoubleMatrix atb, org.apache.spark.mllib.optimization.NNLS.Workspace ws) { throw new RuntimeException(); }
}

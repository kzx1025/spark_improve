...
public  class StandardScalerModel implements org.apache.spark.mllib.feature.VectorTransformer {
  ...
  // not preceding
  private   StandardScalerModel (boolean withMean, boolean withStd, org.apache.spark.mllib.linalg.Vector mean, org.apache.spark.mllib.linalg.Vector variance) { throw new RuntimeException(); }
  private  breeze.linalg.DenseVector<java.lang.Object> factor () { throw new RuntimeException(); }
  /**

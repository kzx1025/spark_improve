...
public  class IndexedRowMatrix implements org.apache.spark.mllib.linalg.distributed.DistributedMatrix {
   ...
   * <p>
   * There is no restriction on m, but we require <code>n^2</code> doubles to fit in memory.
   ...
   * Note that this approach requires <code>O(n^3)</code> time on the master node.
   * <p>

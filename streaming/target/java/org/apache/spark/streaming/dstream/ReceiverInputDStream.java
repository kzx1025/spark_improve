...
public abstract class ReceiverInputDStream<T extends java.lang.Object> extends org.apache.spark.streaming.dstream.InputDStream<T> {
  ...
  private  scala.collection.mutable.HashMap<org.apache.spark.streaming.Time, org.apache.spark.streaming.scheduler.ReceivedBlockInfo[]> receivedBlockInfo () { throw new RuntimeException(); }
  ...
  private  org.apache.spark.streaming.scheduler.ReceivedBlockInfo[] getReceivedBlockInfo (org.apache.spark.streaming.Time time) { throw new RuntimeException(); }
  /**

 ...
 * or stopped completely by <code>stop(...)</code> or
 * <p>
...
public abstract class Receiver<T extends java.lang.Object> implements scala.Serializable {
   ...
   * (threads, buffers, etc.) setup in <code>onStart()</code> must be cleaned up in this method.
   */
  ...
  public  org.apache.spark.streaming.receiver.ReceiverSupervisor executor_ () { throw new RuntimeException(); }
  /** Set the ID of the DStream that this receiver is associated with. */
  private  void setReceiverId (int id_) { throw new RuntimeException(); }
  /** Attach Network Receiver executor to this receiver. */
  private  void attachExecutor (org.apache.spark.streaming.receiver.ReceiverSupervisor exec) { throw new RuntimeException(); }
  /** Get the attached executor. */
  private  org.apache.spark.streaming.receiver.ReceiverSupervisor executor () { throw new RuntimeException(); }
}

...
// no position
private  class ShippableVertexPartition$ implements scala.Serializable {
  /**
   ...
   */
  public <VD extends java.lang.Object> org.apache.spark.graphx.impl.ShippableVertexPartitionOps<VD> shippablePartitionToOps (org.apache.spark.graphx.impl.ShippableVertexPartition<VD> partition, scala.reflect.ClassTag<VD> evidence$4) { throw new RuntimeException(); }
}

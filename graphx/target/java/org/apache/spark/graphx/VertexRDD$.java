...
public  class VertexRDD$ implements scala.Serializable {
   ...
   */
  public <VD extends java.lang.Object> org.apache.spark.graphx.VertexRDD<VD> apply (org.apache.spark.rdd.RDD<scala.Tuple2<java.lang.Object, VD>> vertices, scala.reflect.ClassTag<VD> evidence$15) { throw new RuntimeException(); }
  /**
   ...
   */
  public <VD extends java.lang.Object> org.apache.spark.graphx.VertexRDD<VD> apply (org.apache.spark.rdd.RDD<scala.Tuple2<java.lang.Object, VD>> vertices, org.apache.spark.graphx.EdgeRDD<?, ?> edges, VD defaultVal, scala.reflect.ClassTag<VD> evidence$16) { throw new RuntimeException(); }
  /**
   * Constructs a <code>VertexRDD</code> from an RDD of vertex-attribute pairs. Duplicate vertex entries are
   ...
   */
  public <VD extends java.lang.Object> org.apache.spark.graphx.VertexRDD<VD> apply (org.apache.spark.rdd.RDD<scala.Tuple2<java.lang.Object, VD>> vertices, org.apache.spark.graphx.EdgeRDD<?, ?> edges, VD defaultVal, scala.Function2<VD, VD, VD> mergeFunc, scala.reflect.ClassTag<VD> evidence$17) { throw new RuntimeException(); }
  /**
   ...
   * @param defaultVal the vertex attribute to use when creating missing vertices
   */
  public <VD extends java.lang.Object> org.apache.spark.graphx.VertexRDD<VD> fromEdges (org.apache.spark.graphx.EdgeRDD<?, ?> edges, int numPartitions, VD defaultVal, scala.reflect.ClassTag<VD> evidence$18) { throw new RuntimeException(); }
  private  org.apache.spark.rdd.RDD<org.apache.spark.graphx.impl.RoutingTablePartition> createRoutingTables (org.apache.spark.graphx.EdgeRDD<?, ?> edges, org.apache.spark.Partitioner vertexPartitioner) { throw new RuntimeException(); }
}

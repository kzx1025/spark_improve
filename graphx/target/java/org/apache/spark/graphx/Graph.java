...
public abstract class Graph<VD extends java.lang.Object, ED extends java.lang.Object> implements scala.Serializable {
   ...
   */
  static public <VD extends java.lang.Object, ED extends java.lang.Object> org.apache.spark.graphx.Graph<VD, ED> fromEdges (org.apache.spark.rdd.RDD<org.apache.spark.graphx.Edge<ED>> edges, VD defaultValue, org.apache.spark.storage.StorageLevel edgeStorageLevel, org.apache.spark.storage.StorageLevel vertexStorageLevel, scala.reflect.ClassTag<VD> evidence$14, scala.reflect.ClassTag<ED> evidence$15) { throw new RuntimeException(); }
  /**
   ...
   * @param vertexStorageLevel the desired storage level at which to cache the vertices if necessary
   */
  static public <VD extends java.lang.Object, ED extends java.lang.Object> org.apache.spark.graphx.Graph<VD, ED> apply (org.apache.spark.rdd.RDD<scala.Tuple2<java.lang.Object, VD>> vertices, org.apache.spark.rdd.RDD<org.apache.spark.graphx.Edge<ED>> edges, VD defaultVertexAttr, org.apache.spark.storage.StorageLevel edgeStorageLevel, org.apache.spark.storage.StorageLevel vertexStorageLevel, scala.reflect.ClassTag<VD> evidence$16, scala.reflect.ClassTag<ED> evidence$17) { throw new RuntimeException(); }
  /**
   ...
   */
  static public <VD extends java.lang.Object, ED extends java.lang.Object> org.apache.spark.graphx.GraphOps<VD, ED> graphToGraphOps (org.apache.spark.graphx.Graph<VD, ED> g, scala.reflect.ClassTag<VD> evidence$18, scala.reflect.ClassTag<ED> evidence$19) { throw new RuntimeException(); }
  // not preceding
   ...
   * <p>
   * @see {@link Edge} for the edge type.
   * @see {@link triplets} to get an RDD which contains all the edges
   * along with their vertex data.
   * <p>
   */
  public abstract  org.apache.spark.graphx.EdgeRDD<ED, VD> edges () ;
  /**
   ...
   * <p>
   */
  public abstract <ED2 extends java.lang.Object> org.apache.spark.graphx.Graph<VD, ED2> mapTriplets (scala.Function2<java.lang.Object, scala.collection.Iterator<org.apache.spark.graphx.EdgeTriplet<VD, ED>>, scala.collection.Iterator<ED2>> map, scala.reflect.ClassTag<ED2> evidence$7) ;
  /**
   ...
   */
  public abstract <VD2 extends java.lang.Object, ED2 extends java.lang.Object> org.apache.spark.graphx.Graph<VD, ED> mask (org.apache.spark.graphx.Graph<VD2, ED2> other, scala.reflect.ClassTag<VD2> evidence$8, scala.reflect.ClassTag<ED2> evidence$9) ;
  /**
   ...
   * consider when running <code>mapFunc</code>. If the direction is <code>In</code>, <code>mapFunc</code> will only be run on
   * edges with destination in the active set.  If the direction is <code>Out</code>,
   * <code>mapFunc</code> will only be run on edges originating from vertices in the active set. If the
   * direction is <code>Either</code>, <code>mapFunc</code> will be run on edges with *either* vertex in the active set
   * . If the direction is <code>Both</code>, <code>mapFunc</code> will be run on edges with *both* vertices in the
   ...
   * <p>
   */
  public abstract <A extends java.lang.Object> org.apache.spark.graphx.VertexRDD<A> mapReduceTriplets (scala.Function1<org.apache.spark.graphx.EdgeTriplet<VD, ED>, scala.collection.Iterator<scala.Tuple2<java.lang.Object, A>>> mapFunc, scala.Function2<A, A, A> reduceFunc, scala.Option<scala.Tuple2<org.apache.spark.graphx.VertexRDD<?>, org.apache.spark.graphx.EdgeDirection>> activeSetOpt, scala.reflect.ClassTag<A> evidence$10) ;
  /**
   * Joins the vertices with entries in the <code>table</code> RDD and merges the results using <code>mapFunc</code>.  The
   * input table should contain at most one entry for each vertex.  If no entry in <code>other</code> is
   ...
   * </code></pre>
   */
  public abstract <U extends java.lang.Object, VD2 extends java.lang.Object> org.apache.spark.graphx.Graph<VD2, ED> outerJoinVertices (org.apache.spark.rdd.RDD<scala.Tuple2<java.lang.Object, U>> other, scala.Function3<java.lang.Object, VD, scala.Option<U>, VD2> mapFunc, scala.reflect.ClassTag<U> evidence$11, scala.reflect.ClassTag<VD2> evidence$12, scala.Predef.$eq$colon$eq<VD, VD2> eq) ;
  /**

...
public  class GraphGenerators {
   ...
   * @return
   */
  static public  org.apache.spark.graphx.Graph<java.lang.Object, java.lang.Object> logNormalGraph (org.apache.spark.SparkContext sc, int numVertices, int numEParts, double mu, double sigma) { throw new RuntimeException(); }
  static public  double RMATc () { throw new RuntimeException(); }
  static public  org.apache.spark.graphx.Edge<java.lang.Object>[] generateRandomEdges (int src, int numEdges, int maxVertexId) { throw new RuntimeException(); }
  /**
   ...
   */
  static private  int sampleLogNormal (double mu, double sigma, int maxVal) { throw new RuntimeException(); }
  /**

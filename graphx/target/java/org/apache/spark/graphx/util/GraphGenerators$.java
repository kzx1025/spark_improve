...
public  class GraphGenerators$ {
   ...
   * @return
   */
  public  org.apache.spark.graphx.Graph<java.lang.Object, java.lang.Object> logNormalGraph (org.apache.spark.SparkContext sc, int numVertices, int numEParts, double mu, double sigma) { throw new RuntimeException(); }
  public  double RMATc () { throw new RuntimeException(); }
  public  org.apache.spark.graphx.Edge<java.lang.Object>[] generateRandomEdges (int src, int numEdges, int maxVertexId) { throw new RuntimeException(); }
  /**
   ...
   */
  private  int sampleLogNormal (double mu, double sigma, int maxVal) { throw new RuntimeException(); }
  /**

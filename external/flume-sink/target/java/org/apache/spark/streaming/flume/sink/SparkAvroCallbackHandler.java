 ...
 *                           is rolled back.
 */
private  class SparkAvroCallbackHandler implements org.apache.spark.streaming.flume.sink.SparkFlumeProtocol, org.apache.spark.streaming.flume.sink.Logging {
  ...
  private  java.util.concurrent.ConcurrentHashMap<java.lang.CharSequence, org.apache.spark.streaming.flume.sink.TransactionProcessor> sequenceNumberToProcessor () { throw new RuntimeException(); }
   ...
   */
  private  org.apache.spark.streaming.flume.sink.TransactionProcessor removeAndGetProcessor (java.lang.CharSequence sequenceNumber) { throw new RuntimeException(); }
  /**

...
private  class FlumePollingReceiver extends org.apache.spark.streaming.receiver.Receiver<org.apache.spark.streaming.flume.SparkFlumeEvent> implements org.apache.spark.Logging {
  ...
  private  java.util.concurrent.LinkedBlockingQueue<org.apache.spark.streaming.flume.FlumeConnection> getConnections () { throw new RuntimeException(); }
  private  int getMaxBatchSize () { throw new RuntimeException(); }
}

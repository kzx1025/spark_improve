...
private  class PairwiseRDD extends org.apache.spark.rdd.RDD<scala.Tuple2<java.lang.Object, byte[]>> {
  ...
  public  scala.collection.Iterator<scala.Tuple2<java.lang.Object, byte[]>> compute (org.apache.spark.Partition split, org.apache.spark.TaskContext context, org.apache.spark.scheduler.ShuffleMemorySignal shuffleMemorySignal) { throw new RuntimeException(); }
  // not preceding

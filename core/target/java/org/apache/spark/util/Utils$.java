...
private  class Utils$ implements org.apache.spark.Logging {
  ...
  public  java.io.File sparkBin (java.lang.String sparkHome, java.lang.String which) { throw new RuntimeException(); }
  ...
  public  boolean isAlpha (char c) { throw new RuntimeException(); }
  /** Split a string into words at non-alphabetic characters */
  public  scala.collection.Seq<java.lang.String> splitWords (java.lang.String s) { throw new RuntimeException(); }
  ...
  public  long copyStream (java.io.InputStream in, java.io.OutputStream out, boolean closeStreams) { throw new RuntimeException(); }
  /**
   ...
   * the requested file.
   */
  public  void fetchFile (java.lang.String url, java.io.File targetDir, org.apache.spark.SparkConf conf, org.apache.spark.SecurityManager securityMgr) { throw new RuntimeException(); }
  /**
  ...
  private  boolean isRunningInYarnContainer (org.apache.spark.SparkConf conf) { throw new RuntimeException(); }
  /**
   ...
   */
  private  java.lang.String[] getOrCreateLocalRootDirs (org.apache.spark.SparkConf conf) { throw new RuntimeException(); }
   ...
   */
  public  scala.collection.Seq<java.io.File> findOldFiles (java.io.File dir, long cutoff) { throw new RuntimeException(); }
  /**
   ...
   * with an exit code other than 0.
   */
  public  void execute (scala.collection.Seq<java.lang.String> command) { throw new RuntimeException(); }
  /**
   ...
   */
  private  scala.util.matching.Regex SPARK_CLASS_REGEX () { throw new RuntimeException(); }
  /**
  ...
  public  boolean isSpace (char c) { throw new RuntimeException(); }
  /**
   ...
   */
  public  long timeIt (int numIters, scala.Function0<scala.runtime.BoxedUnit> f) { throw new RuntimeException(); }
  /**
   ...
   */
  public  org.apache.hadoop.fs.FileSystem getHadoopFileSystem (java.net.URI path) { throw new RuntimeException(); }
  /**
   * Return a Hadoop FileSystem with the scheme encoded in the given path.
   */
  public  org.apache.hadoop.fs.FileSystem getHadoopFileSystem (java.lang.String path) { throw new RuntimeException(); }
  /**
  ...
  public  java.lang.String exceptionString (java.lang.Exception e) { throw new RuntimeException(); }
  /** Return a nice string representation of the exception, including the stack trace. */
  public  java.lang.String exceptionString (java.lang.String className, java.lang.String description, java.lang.StackTraceElement[] stackTrace) { throw new RuntimeException(); }
  /**

...
private  class CacheManager implements org.apache.spark.Logging {
  ...
  public <T extends java.lang.Object> scala.collection.Iterator<T> getOrCompute (org.apache.spark.rdd.RDD<T> rdd, org.apache.spark.Partition partition, org.apache.spark.TaskContext context, org.apache.spark.storage.StorageLevel storageLevel, org.apache.spark.scheduler.ShuffleMemorySignal shuffleMemorySignal) { throw new RuntimeException(); }
  /**

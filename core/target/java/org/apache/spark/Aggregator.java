...
public  class Aggregator<K extends java.lang.Object, V extends java.lang.Object, C extends java.lang.Object> implements scala.Product, scala.Serializable {
  ...
  public  scala.collection.Iterator<scala.Tuple2<K, C>> combineValuesByKey (scala.collection.Iterator<scala.Product2<K, V>> iter, org.apache.spark.TaskContext context, org.apache.spark.scheduler.ShuffleMemorySignal shuffleMemorySignal) { throw new RuntimeException(); }
  ...
  public  scala.collection.Iterator<scala.Tuple2<K, C>> combineCombinersByKey (scala.collection.Iterator<scala.Product2<K, C>> iter, org.apache.spark.TaskContext context, org.apache.spark.scheduler.ShuffleMemorySignal shuffleMemorySignal) { throw new RuntimeException(); }
}

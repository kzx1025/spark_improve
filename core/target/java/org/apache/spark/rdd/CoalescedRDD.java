...
private  class CoalescedRDD<T extends java.lang.Object> extends org.apache.spark.rdd.RDD<T> {
  ...
  public  scala.collection.Iterator<T> compute (org.apache.spark.Partition partition, org.apache.spark.TaskContext context, org.apache.spark.scheduler.ShuffleMemorySignal shuffleMemorySignal) { throw new RuntimeException(); }

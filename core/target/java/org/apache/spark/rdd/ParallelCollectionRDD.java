...
private  class ParallelCollectionRDD<T extends java.lang.Object> extends org.apache.spark.rdd.RDD<T> {
  ...
  public  org.apache.spark.InterruptibleIterator<T> compute (org.apache.spark.Partition s, org.apache.spark.TaskContext context, org.apache.spark.scheduler.ShuffleMemorySignal shuffleMemorySignal) { throw new RuntimeException(); }
